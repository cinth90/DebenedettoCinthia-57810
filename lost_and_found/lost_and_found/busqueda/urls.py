...
urlpatterns = [
   ...
   #Testimonios
    ...
    path('testimonialCreate/', TestimonialCreate.as_view(), name="testimonialCreate"), 
    path('testimonialUpdate/<int:pk>/', TestimonialUpdate.as_view(), name="testimonialUpdate"), 
    path('testimonialDelete/<int:pk>/', TestimonialDelete.as_view(), name="testimonialDelete"),  
